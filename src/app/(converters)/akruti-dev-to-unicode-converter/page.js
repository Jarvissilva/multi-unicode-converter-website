...
import { akrutidevToUnicode } from "functions/akrutidev-converter";
...
export default function Page() {
  ...
  const handleConversion = (e) => {
    setOutput(akrutidevToUnicode(e.target.value));
  };
  ...
  return (
    <>
      ...
      <div className="mt-5 space-y-5">
        <H2>About Akruti Dev</H2>
        <P>
          Akruti Dev is a popular Indian font and keyboard layout used for
          typing in various Indian languages, including Hindi, Marathi,
          Gujarati, and more.
        </P>
        <H2>Why convert Akruti dev to unicode?</H2>
        <P>
          Converting Akruti dev text to Unicode ensures compatibility,
