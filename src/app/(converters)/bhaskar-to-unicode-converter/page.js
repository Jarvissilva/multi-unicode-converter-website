...
import { bhaskarToUnicode } from "functions/bhaskar-converter";
...
export default function Page() {
  ...
  const handleConversion = (e) => {
    setOutput(bhaskarToUnicode(e.target.value));
  };
  ...
  return (
    <>
      ...
      <div className="mt-5 space-y-5">
        <H2>What is Bhaskar?</H2>
        <P>
          <ExternalLink href="https://hindi-fonts.com/fonts/bhaskar-normal">
            Bhaskar
          </ExternalLink>{" "}
          is a popular hindi font, It is an non unicoded font it is maily used
          for logo design, pamphlets, posters, magazines and advertisements.
        </P>
        <H2>Why convert Bhaskar to unicode?</H2>
        <P>
          Converting Bhaskar text to Unicode ensures compatibility,
