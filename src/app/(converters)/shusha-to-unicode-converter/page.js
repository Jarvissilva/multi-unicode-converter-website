...
import { shushaToUnicode } from "functions/shusha-converter";

export default function Page() {
  const [output, setOutput] = useState("");

  const handleConversion = (e) => {
    setOutput(shushaToUnicode(e.target.value));
  };
  ...
  return (
    <>
      ...
      <div className="mt-5 space-y-5">
        <H2>What is Shusha?</H2>
        <P>
          <ExternalLink href="https://indiatyping.com/index.php/download/201-shusha-font">
            Shusha
          </ExternalLink>{" "}
          is a font which is used in hindi typing in computer system, It is an
          non unicoded font.
        </P>
        <H2>Why convert Shusha to unicode?</H2>
        <P>
          Converting Shusha text to Unicode ensures compatibility,
