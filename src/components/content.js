...
export function H1({ children }) {
  return (
    <h1 className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent text-[clamp(1.7rem,5vw,2.7rem)] capitalize font-black leading-tight">
      {children}
    </h1>
  );
}
