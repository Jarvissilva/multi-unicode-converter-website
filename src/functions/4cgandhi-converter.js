export function gandhiToUnicode(text) {
  var array_one = [
    "X",
    "Y",
    "Û",
  ...
  //     "आपके द्वारा हमें यूनीकोड में बदलने के लिए दिये गये शब्द 4cGandhi लिपि में नहीं हैं";
  ...
  function Replace_Symbols() {
    if (modified_substring != "") {
      ...
      modified_substring = modified_substring.replace(/Ë/g, "Êं");
      modified_substring = modified_substring.replace(/Í/g, "र्d");
      ...
      modified_substring = modified_substring.replace(/Ì/g, "ÊÎ");
      modified_substring = modified_substring.replace(/Î/g, "da");
...
export function unicodeToGandhi(text) {
  var array_one = [
    "क़्",
    "ख़्",
    "ग़्",
    ...
    if (modified_substring != "") {
      ...
      while (position_of_f != -1) {
        ...
        while (
          ...
          modified_substring = modified_substring.replace(
            string_to_be_replaced + "d",
            "d" + string_to_be_replaced
          );
      ...
      while (position_of_half_R > 0) {
        ...
        var character_right_to_probable_position_of_Z =
          modified_substring.charAt(probable_position_of_Z + 0);
        while (
