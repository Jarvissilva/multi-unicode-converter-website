export function chanakyaToUnicode(text) {
  var array_one = [
    "¤",
    "U",
    "¢ð",
  ...
  function replaceSymbols(modified_substring) {
    if (modified_substring !== "") {
      ...
      while (position_of_f !== -1) {
        ...
        modified_substring = modified_substring.replace(
          "ç" + charecter_right_to_f,
          charecter_right_to_f + "ि"
        );
        position_of_f++;
        ...
        while (
          ...
          var string_to_be_replaced =
            modified_substring.charAt(position_of_f + 1) +
            modified_substring.charAt(position_of_f + 2);
          modified_substring = modified_substring.replace(
      ...
      var set_of_matras = "ा ि ी ु ू ृ े ै ो ौ ं ः ँ ॅ";
      ...
      while (position_of_Z > 0) {
        ...
        charecter_to_be_replaced = modified_substring.substr(
          probable_position_of_half_r,
          position_of_Z - probable_position_of_half_r
        );
...
export function unicodeToChanakya(inputText) {
  var array_one = [
    "‘",
    "’",
    "“",
  ...
  if (array_one_length !== array_two_length) {
    console.log("Error: Both the arrays are NOT of equal length");
    return;
  }
  ...
  function Replace_Symbols() {
    if (modified_substring !== "") {
      ...
      while (position_of_half_R > 0) {
        ...
        while (
          set_of_matras.indexOf(character_right_to_probable_position_of_Z) !==
          -1
        ) {
        ...
        var string_to_be_replaced = modified_substring.substr(
